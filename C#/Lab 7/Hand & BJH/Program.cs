...
namespace CardTests
{
    class Program
    {
        ...
        static void TestHasCard()
        {
            ...
            if (h.HasCard(c3))
                Console.WriteLine(c3 + " is in the hand.");
            else
                Console.WriteLine(c3 + " is NOT in the hand");
        }
        ...
        static void TestIndexOf()
        {
            ...
            h.Add(c1); h.Add(c2); h.Add(c3); h.Add(c4);

            Console.WriteLine("Testing IndexOf");
            Console.WriteLine("The 6 of Diamonds is third. Expecting 2. " + h.IndexOf(c3));
            Console.WriteLine("The Ace of Clubs is first. Expecting 0. " + h.IndexOf(1, 1));
        }

        static void TestNumCards()
        {
            Hand h = new Hand();
            Card c1 = new Card();
            Card c2 = new Card(3, 4);
            ...
            Console.WriteLine("Testing Number of cards");
            Console.WriteLine("Expecting 4. " + h.NumCards);
        }

        static void TestGetCardandDiscard()
        {
            Hand h = new Hand();
            Card c1 = new Card();
            Card c2 = new Card(3, 4);
            ...
            Console.WriteLine("Testing Get Card");
            Console.WriteLine("Expecting 6 of Diamonds. " + h[2]);
            Console.WriteLine();

            Console.WriteLine("Testing Discard");
            h.Discard(2);
            Console.WriteLine("Expecting 6 of Diamonds not to be on the hand. "+ "\n" + h);
        }
    }
}
